...
**Remember that _RunAs_ is part of the _Tasks'_ configuration, as _Tasks_ are responsible for Scripts' execution**. Please check the [Tasks Documentation](tasks#create-a-script-task) for further details.
